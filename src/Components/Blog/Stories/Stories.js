...
<img  src='https://images.pexels.com/photos/9705666/pexels-photo-9705666.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' className='w-11/12 xs:w-5/6 md:3/4 ml-auto h-full'/>
{/* </div> */}
</div>
<div className='video-watch-2  grid md:fleitems-center place-content-center'>
    ...
    <div className='w-full  h-full items-center  flex place-content-center individual-suggested-icon'><p className='my-auto'><MdOutlinePlayCircleOutline className='text-white  text-3xl'/></p></div>
        <div className='suggested-video-img'><img src='https://images.pexels.com/photos/4077869/pexels-photo-4077869.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load' className='individual-suggested-video-img' /></div>
    </div>
    <div className='individual-suggested-video'>
    <div className='w-full  h-full items-center  flex place-content-center individual-suggested-icon'><p className='my-auto'><MdOutlinePlayCircleOutline className='text-white  text-3xl'/></p></div>
        <img src='https://images.pexels.com/photos/3800499/pexels-photo-3800499.jpeg?auto=compress&cs=tinysrgb&w=1600' className='individual-suggested-video-img' />
    </div>
    <div className='individual-suggested-video'>
    <div className='w-full  h-full items-center  flex place-content-center individual-suggested-icon'><p className='my-auto'><MdOutlinePlayCircleOutline className='text-white  text-3xl'/></p></div>
        <img src='https://images.pexels.com/photos/5256142/pexels-photo-5256142.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' className='individual-suggested-video-img' />
    </div>
