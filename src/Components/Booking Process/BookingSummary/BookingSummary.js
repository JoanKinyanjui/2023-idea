...
function BookingSummary() {
  return (
    ...
    <p className='text-xl md:text-2xl font-semibold pt-12 py-4'>Appointment Summary</p>

    <div className='Summary-content grid items-center h-full'>
      <p className='w-full flex place-content-center'>Congratulations Nathan your appointment has been booked Successfully !!!</p>
