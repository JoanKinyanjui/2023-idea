  ...
  return (
    <div className='Professionals'>
        ...
        <div className='para-galla'>
            ...
            <div className='para text-base py-2 md:py-4 grid items-start md:mt-24'>Tap into the world's largest network of licensed, accredited, and experienced therapists who can help you with a range of issues including depression, anxiety, relationships, trauma, grief, and more. With our therapists, you get the same professionalism and quality you would expect from an in-office therapist, but with the ability to communicate when and how you want.
